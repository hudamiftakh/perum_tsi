...
<body>
  <div class="page-wrapper">
    <div class="body-wrapper">
                ...
                <tr>
                 <!--  <td width="1px">
                  ...
                  <td width="50%" style="text-align: left; line-height: 15px; padding-left: 2px">
                    <label style="font-weight: bold; color: white; font-size: 19px; padding-top: 10px">Perpustakaan <label style="color: #f9ca24; font-weight: bold;">Digital</label></label><br>
      ...
      <script src="<?php echo base_url(); ?>dist/libs/alert/sweetalert2@9.js"></script>
      
      <?php include "perpustakaan/perpustakaan_js.php"; ?>
