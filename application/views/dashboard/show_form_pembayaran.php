  ...
  <div class="container">
    <div class="card shadow-lg">
      ...
      <div class="card-body">
        ...
        <?php endif; ?>
        <form id="formBayar" method="post" action="<?php echo base_url('proses-pembayaran'); ?>" enctype="multipart/form-data">
          <div class="mb-3">
            <label for="nama" class="form-label">Nama Warga</label>
            <select class="form-select" name="user_id" id="nama" required>
              <option value="">Pilih nama warga...</option>
              <option value="1">Budi - RT01/RW02</option>
              <option value="2">Siti - RT02/RW03</option>
            </select>
          </div>
          ...
          <div id="opsiCicilan" class="row d-none">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="total_cicilan" id="total_cicilan" class="form-control" placeholder="Contoh: 1500000">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="jumlah_bayar" value="125000" id="jumlah_bayar" required>
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea name="keterangan" class="form-control" rows="2" placeholder="Contoh: Pembayaran bulan Januari hingga Maret"></textarea>
          </div>
