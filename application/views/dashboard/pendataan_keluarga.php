...
<body>
    <div class="container py-4">
            ...
            <div class="card-body">
                <form id="formKeluarga" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label for="nomorRumah" class="form-label">Nomor Rumah <span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2" id="nomorRumah" name="nomor_rumah[]" multiple="multiple"
                                required>
                        ...
                        <div class="col-md-6">
                            <label for="statusRumah" class="form-label">Status Tempat Tinggal (Rumah TSI) <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label for="alamat" class="form-label">Alamat Lengkap (KK) <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="alamat" name="alamat" required />
                        </div>

                        <div class="col-sm-6 col-md-3">
                            <label for="provinsi" class="form-label">Provinsi (KK) <span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2" id="provinsi" name="provinsi" required></select>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <label for="kota" class="form-label">Kota/Kabupaten (KK) <span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2" id="kota" name="kota" required></select>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <label for="kecamatan" class="form-label">Kecamatan (KK) <span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2" id="kecamatan" name="kecamatan" required></select>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <label for="kelurahan" class="form-label">Kelurahan (KK) <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <small class="form-text text-muted">Nomor ini akan digunakan untuk menerima notifikasi IPL
                                dan informasi paguyuban melalui WhatsApp.</small>
                        </div>
        ...
        <a href="<?php echo base_url('keterisian'); ?>" class="floating-button">
            📊 Keterisian Pendataan
        </a>
    </div>
    ...
    <!-- <template id="templateAnggota">
        <div class="card border rounded p-3 mt-3 position-relative anggota-keluarga">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label">Nama Instansi / Perusahaan / Usaha <span
                            class="text-danger">*</span></label>
