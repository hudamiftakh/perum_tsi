        ...
        <form action="" method="get">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <select class="js-example-basic-single" name="jenis_aktivitas" style="width: 97%;">
                ...
                <div class="col">
                    ...
                    <select class="js-example-basic-single" name="id_pegawai" style="width: 97%;">
                ...
                <div class="col">
                    ...
                    <select class="js-example-basic-single" name="approval" style="width: 97%;">
                        <option value="">Pilih Aktivitas</option>
                        <?php 
							if(in_array($_SESSION['username']['role'],array('admin','approval'))) {
